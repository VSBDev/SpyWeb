...
const tutorial: LevelDef = {
  ...
  items: [
    ...
    { kind: "pole", x: 3, z: 2 },
    { kind: "well", x: -9, z: -31 },
    { kind: "agave", x: 12, z: 18, seed: 2 },
    { kind: "agave", x: -17, z: 17.5, seed: 5 },
    { kind: "prickly", x: 28, z: 10, seed: 3 },
    { kind: "prickly", x: -33, z: -8, seed: 7 },
    { kind: "fruitcrates", x: -3.5, z: 22.5, seed: 2 },
    { kind: "oleander", x: -19, z: -14, seed: 4 },
    { kind: "lemon", x: -21, z: -6, seed: 6 },
...
const villa: LevelDef = {
  ...
  items: [
    ...
    { kind: "lemon", x: -14, z: -28, seed: 2 },
    { kind: "lemon", x: 14, z: -28, seed: 4 },
    { kind: "lemon", x: -20, z: -12, seed: 6 },
    { kind: "lemon", x: 21, z: -12, seed: 8 },
    { kind: "agave", x: -7.5, z: 34, seed: 3 },
    { kind: "agave", x: 7.5, z: 34, seed: 6 },
    { kind: "oleander", x: -12, z: 12, seed: 5 },
    { kind: "oleander", x: 13, z: 13, seed: 9 },
    { kind: "vespa", x: 4.5, z: 33, rot: 2.4, seed: 2 },
    { kind: "cafeset", x: -6, z: -3.5, seed: 3 },
    { kind: "prickly", x: -42, z: 33, seed: 4 },
  ],
  guards: [
...
const harbor: LevelDef = {
  ...
  items: [
    ...
    { kind: "fruitcrates", x: -2, z: -36.5, seed: 3 },
    { kind: "fruitcrates", x: 4, z: 40, seed: 6 },
    { kind: "vespa", x: -33, z: 27, rot: -0.8, seed: 4 },
    { kind: "cafeset", x: -37.5, z: 25, seed: 2 },
    { kind: "agave", x: -44, z: 4, seed: 3 },
    { kind: "agave", x: -47, z: 34, seed: 7 },
    { kind: "prickly", x: -54, z: -20, seed: 5 },
    { kind: "oleander", x: -28, z: -22, seed: 6 },
  ],
  guards: [
    {
      x: 8, z: -35,
...
const monastery: LevelDef = {
  ...
  items: [
    ...
    { kind: "lemon", x: -6, z: 1, seed: 3 },
    { kind: "lemon", x: 6, z: 1, seed: 5 },
    { kind: "oleander", x: -16, z: 12, seed: 2 },
    { kind: "oleander", x: 17, z: 12.5, seed: 7 },
    { kind: "agave", x: -24, z: 26, seed: 4 },
    { kind: "agave", x: 24, z: 27, seed: 8 },
    { kind: "prickly", x: -36, z: -18, seed: 6 },
  ],
  guards: [
...
const fortress: LevelDef = {
  ...
  items: [
    ...
    { kind: "agave", x: -33, z: -12, seed: 2 },
    { kind: "agave", x: 33, z: 20, seed: 5 },
    { kind: "prickly", x: -36, z: 14, seed: 3 },
    { kind: "prickly", x: 12, z: -33, seed: 8 },
    { kind: "oleander", x: -14, z: 10, seed: 4 },
    { kind: "fruitcrates", x: -17, z: 25, seed: 5 },
    // supplies
